        ...
        @if(isset($movie))
          ...
          <div class="row">
            ...
            @if(isset($movie->multilinks) && count($movie->multilinks) > 0 )   
              ...
              @if(in_array(1, $mlc))
                 <button type="button" class="btn" data-toggle="collapse" data-target="#downloadmovie">{{__('staticwords.download')}}</button>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7 pad-0">
                    ...
                    <p>
                     ...
                     @if($subscribed==1)
                    <div class="des-btn-block des-in-list">
                      <a href="{{ route('watchmovie',$series->id)  }}" class="iframe btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('staticwords.playnow')}}</span></a>
                      @if($series->trailer_url != null || $series->trailer_url != '')
                        <a href="{{ route('watchTrailer',$series->id)  }}" class="iframe btn-default">{{__('staticwords.watchtrailer')}}</a>
                      @endif
                      @if (isset($wishlist_check->added))
