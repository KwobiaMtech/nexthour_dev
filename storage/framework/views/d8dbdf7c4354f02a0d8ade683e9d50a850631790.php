  ...
  <aside class="main-sidebar" style="background-image: url(<?php echo e(url('images/sidebar-7.jpg')); ?>);">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#" class="<?php echo e(Nav::isResource('home_slider')); ?> <?php echo e(Nav::isResource('landing-page')); ?> <?php echo e(Nav::isResource('auth-page-customize')); ?> <?php echo e(Nav::isRoute('social.ico')); ?> <?php echo e(Nav::isResource('home-block')); ?>" title="Site Customization">
         ...
         <li><a class="<?php echo e(Nav::isRoute('pwa.setting.index')); ?>" href="<?php echo e(route('pwa.setting.index')); ?>" title="Custom Pages"><i class="material-icons">phonelink_setup</i> <span>PWA Settings</span></a></li>

        <li><a class="<?php echo e(Nav::isResource('custom_page')); ?>" href="<?php echo e(url('/admin/custom_page')); ?>" title="Custom Pages"><i class="material-icons">library_books</i> <span>Custom Pages</span></a></li>

        <li class="treeview">
          <a href="#" class="<?php echo e(Nav::isRoute('pricing.get')); ?> <?php echo e(Nav::isResource('languages')); ?>">
        ...
        <li><a class="<?php echo e(Nav::isRoute('device_history')); ?>" href="<?php echo e(route('device_history')); ?>" title="Device History"><i class="material-icons">history</i> <span>Device History</span></a></li>
       
         <li><a class="<?php echo e(Nav::isRoute('revenue.report')); ?>" href="<?php echo e(url('admin/report/revenue')); ?>" title="Active Plan"><i class="material-icons">trending_up</i> <span>Revenue Report</span></a>
        </li>
...
<p class="version">Version 2.9&emsp;</p>
<!-- /.content-wrapper -->
<!-- Main Footer -->
...
<script src="<?php echo e(url('js/datatable.js')); ?>" type="text/javascript"></script>
