                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <select name="view[3]" id="select3" class="form-control">
                      ...
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 3 && $section->view == 1) selected="selected" @else  @endif  @endforeach value="0">Grid View</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <select name="view[4]" id="select4" class="form-control">
                      ...
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 4 && $section->view == 1) selected="selected" @else  @endif  @endforeach value="0">Grid View</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <select name="view[5]" id="select5" class="form-control">
                      ...
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 5 && $section->view == 1) selected="selected" @else  @endif  @endforeach value="0">Grid View</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <select name="view[6]" id="select6" class="form-control">
                      ...
                      <option @foreach($menu->menusections as $section) @if($section->section_id == 6 && $section->view == 1) selected="selected" @else  @endif  @endforeach value="0">Grid View</option>
                    </select>
                  </div>
