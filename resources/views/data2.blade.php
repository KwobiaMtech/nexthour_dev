                    ...
                    $moviegenreitems = array_values(array_filter($moviegenreitems));
                      ...
                      foreach ($menu_data as $key => $item) {
                           ...
                           $gtvs =  \DB::table('tv_series')
                                  ...
                                  ->select('seasons.id as seasonid','tv_series.genre_id as genre_id','tv_series.id as id','tv_series.type as type','tv_series.status as status','tv_series.title as title','tv_series.thumbnail as thumbnail')->where('tv_series.genre_id', 'LIKE', '%' . $genre->id . '%')
                                   ...
                                   @if($item->status == 1)
                                      ...
                                      @if($item->type == 'T')
                                       ...
                                       <div class="genre-slide">
                                          ...
                                          <div class="genre-slide-dtl">
                                             @if($auth && $subscribed==1)
                                              <h5 class="genre-dtl-heading"><a href="{{url('show/detail/'.$item->seasonid)}}">{{$item->title}}</a></h5>
                                              @else
                                               <h5 class="genre-dtl-heading"><a href="{{url('show/guest/detail/'.$item->seasonid)}}">{{$item->title}}</a></h5>
                                              @endif
                                          </div>  
                                       </div>
                                      @endif
