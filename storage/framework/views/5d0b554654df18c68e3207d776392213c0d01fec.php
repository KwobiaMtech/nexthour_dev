          ...
          <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="m-t-lg">
              ...
              ?>
                ...
                <a href="<?php echo e(url('/auth/google')); ?>" class="btn btn--form btn--form-login gplus-btn" title=<?php echo e(__('registerwithgoogle')); ?>><i class="fa fa-google"></i> <?php echo e(__('staticwords.registerwithgoogle')); ?></a>
                <?php endif; ?>
