                                                ...
                                                @if($item->type == 'T')
                                                  ...
                                                  <div class="col-lg-4 col-md-9 col-xs-6 col-sm-6">
                                                    <div class="genre-slide-image protip">
                                                       @if($auth && $subscribed==1)
                                                        <a @if(isset($item->seasonid)) href="{{url('show/detail',$item->seasonid)}}" @endif>
                                                          @if($src)
                                                        ...
                                                        @else
                                                         <a @if(isset($item->seasonid)) href="{{url('show/guest/detail',$item->seasonid)}}" @endif>
                                                          @if($src)
                                                            <img src="{{ $src }}" class="img-responsive" alt="genre-image">
