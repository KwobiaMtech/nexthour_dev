          ...
          <form method="POST" action="{{ route('register') }}">
            ...
            <div class="m-t-lg">
              ...
              @endphp
                ...
                <a href="{{ url('/auth/google') }}" class="btn btn--form btn--form-login gplus-btn" title={{__('registerwithgoogle')}}><i class="fa fa-google"></i> {{__('staticwords.registerwithgoogle')}}</a>
                @endif
