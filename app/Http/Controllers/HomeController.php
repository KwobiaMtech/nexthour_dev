...
class HomeController extends Controller
{
    ...
    public function guestindex(Request $request,$menu_slug)
    {
        ...
        if($config->prime_genre_slider == 1) {
             //Layout 1
              return view('home', compact('getallgenre','menu_data', 'recent_data', 'ad', 'sliderview', 'age', 'genres', 'menuh', 'catlog', 'withlogin', 'menu', 'subscribed','home_blocks','audiolanguages','section6'));
        }else{
            //Layout 2
              return view('home2', compact('getallgenre','menu_data', 'recent_data', 'ad', 'sliderview', 'age', 'genres', 'menuh', 'catlog', 'withlogin', 'menu', 'subscribed','home_blocks','audiolanguages','section6'));
        } 
    ...
    public function index(Request $request,$menu_slug)
    {
        ...
        if($config->prime_genre_slider == 1) {
             //Layout 1
             return view('home', compact('menu_data','recent_data', 'home_slides', 'ad',  'age', 'genres', 'menuh', 'catlog', 'withlogin', 'menu', 'subscribed','watchistory','home_blocks','audiolanguages','section6','getallgenre'));
        }else{
            //Layout 2
             return view('home2', compact('menu_data','recent_data', 'home_slides', 'ad',  'age', 'genres', 'menuh', 'catlog', 'withlogin', 'menu', 'subscribed','watchistory','home_blocks','audiolanguages','section6','getallgenre'));
        } 
    ...
    public function director_search($director_search)
    {
        ...
        $filter_video = $filter_video->flatten();
        return view('search', compact('filter_video', 'searchKey','director'));
    }
