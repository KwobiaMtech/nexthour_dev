                  ...
                  <div class="col-sm-3">
                    ...
                    <div class="movie-series-img">
                      @if(!is_null($director->image))
                        <img src="{{asset('images/directors/'.$director->image)}}" class="img-responsive actor_image" alt="Director-image">
                      @else
                        <img src="{{asset('images/default-thumbnail.jpg')}}" class="img-responsive actor_image" alt="genre-image">
                      ...
                      @else
                        @if(isset($item->episodes[0]))
                           @if($item->episodes[0]->video_link->iframeurl !="")
                            ...
                            <a href="#" onclick="playoniframe('{{ $item->episodes[0]->video_link->iframeurl }}','{{ $item->id }}','tv')" class="btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('staticwords.playnow')}}</span>
                             </a>
