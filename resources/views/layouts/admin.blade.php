  ...
  <aside class="main-sidebar" style="background-image: url({{url('images/sidebar-7.jpg')}});">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#" class="{{ Nav::isResource('home_slider') }} {{ Nav::isResource('landing-page') }} {{ Nav::isResource('auth-page-customize') }} {{ Nav::isRoute('social.ico') }} {{ Nav::isResource('home-block') }}" title="Site Customization">
         ...
         <li><a class="{{ Nav::isRoute('pwa.setting.index') }}" href="{{route('pwa.setting.index')}}" title="Custom Pages"><i class="material-icons">phonelink_setup</i> <span>PWA Settings</span></a></li>

        <li><a class="{{ Nav::isResource('custom_page') }}" href="{{url('/admin/custom_page')}}" title="Custom Pages"><i class="material-icons">library_books</i> <span>Custom Pages</span></a></li>

        <li class="treeview">
          <a href="#" class="{{ Nav::isRoute('pricing.get') }} {{ Nav::isResource('languages') }}">
        ...
        <li><a class="{{ Nav::isRoute('device_history') }}" href="{{ route('device_history') }}" title="Device History"><i class="material-icons">history</i> <span>Device History</span></a></li>
       
         <li><a class="{{ Nav::isRoute('revenue.report')}}" href="{{url('admin/report/revenue')}}" title="Active Plan"><i class="material-icons">trending_up</i> <span>Revenue Report</span></a>
        </li>
        ...
        <li class="treeview">
          <a href="#" class="{{ Nav::isResource('settings') }} {{ Nav::isRoute('term_con') }} {{ Nav::isRoute('pri_pol') }} {{ Nav::isRoute('refund_pol') }}{{ Nav::isRoute('adsense') }}{{ Nav::isRoute('sociallogin') }} {{ Nav::isRoute('copyright') }} {{ Nav::isRoute('mail.getset') }} {{ Nav::isRoute('term_con') }}" title="Site Settings">
